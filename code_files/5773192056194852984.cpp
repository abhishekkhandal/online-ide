...
cout << "\n\t033[1;32m*[0m Type [1;36mls[0m to list all the file available.";
cout << "\n\t033[1;32m*[0m Use [1;36mNANO[0m or [1;36mVIM[0m to edit file.";
cout << "\n\t Eg. '[1;36mnano main.cpp[0m' (without quotes).";
cout << "\n\t	[1;36mctrl + x[0m to write changes made in the file.\n\t	Press [1;36my[0m to save the file.";
cout << "\n\t033[1;32m*[0m Compile it manually: '[1;36mg++ main.cpp -o myprog[0m'.";
cout << "\n\t033[1;32m*[0m Execute: '[1;36m./myprog[0m'.\n\n";
